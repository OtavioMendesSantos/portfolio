...
const StyledWrapper = styled(Box)`
  /* Opcional: Se quiser centralizar a máquina dentro do elemento pai, 
  ...
  */
  ...
  .container {
    ...
    /* top e left foram removidos para evitar que o elemento escape do fluxo do DOM */
  }
  ...
  .coffee-header__display {
    ...
    left: calc(50% - 25px);
    border-radius: 50%;
    background-color: var(--primary-light-color, #9acfc5);
    border: 5px solid var(--primary-main, #43beae);
  ...
  .coffee-footer {
    ...
    bottom: 25px;
    left: calc(50% - 47.5%);
    background-color: var(--primary-main, #41bdad);
    border-radius: 10px;
  }
  .coffee-footer::after {
    content: "";
